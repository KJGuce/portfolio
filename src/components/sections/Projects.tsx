...
const projects: Project[] = [
  {
    title: "KoiPond",
    description:
      "A community resource and volunteer matching app designed to connect people who have something to give with those who are in need. It facilitates community support through acts of service and kindness, helping to address underutilized resources and volunteer opportunities.",
    technologies: [
      "React Native",
      "Expo",
      "TypeScript",
